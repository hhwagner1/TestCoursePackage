...
The dataset 'ralu.loci' is available in the package 'TestCoursePackage'. Here we first export it as a comma separated file (.csv), as this is the recommended format for importing your own data (e.g. from Excel). We save the output file in a folder 'output' in your active working directory.
