...
We know that these coordinates are UTM zone 11 (North) coordinates, hence we can use a helper function to find the correct 'proj4' string, using function 'get_proj4' from the 'tmaptools' package.
