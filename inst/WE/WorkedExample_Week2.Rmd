...
Then we create a loop through all sampling locations, calculating class-level metrics for each one within its buffer (see video for further explanations).
